...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //we are using streams and the filter method to ask if themass is > 80
        //if it is they get added to the new list, if not they are ommited from the new list
        List<Character> heavyCharacters = characters.stream()
                .filter(character -> character.getMass() > 80)
                .toList();

        //looping over heavyCharacters to display the list
